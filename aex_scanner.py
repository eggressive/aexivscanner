...
if not FAIR_VALUE_ESTIMATES:
    ...
    'RAND.AS': 32.34442058751124,
    'REN.AS': 23.177774542763167,
    'SHELL.AS': 90.69937845184508,
    'UNA.AS': 57.170103044874686,
    'UMG.AS': 16.141194996884682,
    'WKL.AS': 138.5335351707761,
}
